  ...
  return (
    <div className="mx-auto max-w-6xl px-4">
      ...
      <section id="about" className="py-12 sm:py-16 border-b border-neutral-900">
        ...
        <div className="mt-4 max-w-3xl mx-auto text-neutral-300 leading-relaxed whitespace-pre-line">
          {aboutText}
        </div>
      </section>
      ...
      <section id="work" className="py-12 sm:py-16">
        ...
        <p className="mt-4 max-w-3xl mx-auto text-neutral-300 leading-relaxed">{t('work.body')}</p>
